...
public static class ChatTypeExt
{
    ...
    public static UiConfigOption ToConfigEntry(this ChatType type) => type switch
    {
        ...
        ChatType.Alliance => UiConfigOption.ColorAlliance,
        ...
        ChatType.CrossLinkshell1 => UiConfigOption.ColorCWLS,
        ChatType.CrossLinkshell2 => UiConfigOption.ColorCWLS2,
        ChatType.CrossLinkshell3 => UiConfigOption.ColorCWLS3,
        ChatType.CrossLinkshell4 => UiConfigOption.ColorCWLS4,
        ChatType.CrossLinkshell5 => UiConfigOption.ColorCWLS5,
        ChatType.CrossLinkshell6 => UiConfigOption.ColorCWLS6,
        ChatType.CrossLinkshell7 => UiConfigOption.ColorCWLS7,
        ChatType.CrossLinkshell8 => UiConfigOption.ColorCWLS8,
        ChatType.FreeCompany => UiConfigOption.ColorFCompany,
        ChatType.NoviceNetwork => UiConfigOption.ColorBeginner,
        ChatType.NoviceNetworkSystem => UiConfigOption.ColorBeginnerAnnounce,
        ...
        ChatType.Healing => UiConfigOption.ColorCureGive,
        ...
        ChatType.PvpTeam => UiConfigOption.ColorPvPGroup,
        ChatType.Damage => UiConfigOption.ColorAttackSuccess,
        ChatType.Action => UiConfigOption.ColorAction,
        ChatType.Item => UiConfigOption.ColorItem,
        ChatType.Miss => UiConfigOption.ColorAttackFailure,
        ChatType.Echo => UiConfigOption.ColorEcho,
        ChatType.BattleSystem => UiConfigOption.ColorSysBattle,
        ChatType.GatheringSystem => UiConfigOption.ColorSysGathering,
        ChatType.Error => UiConfigOption.ColorSysErr,
        ChatType.Crafting => UiConfigOption.ColorCraft,
        ChatType.Gathering => UiConfigOption.ColorGathering,
